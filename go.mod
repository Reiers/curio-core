...
require (
	...
	github.com/Reiers/lantern v1.5.1-0.20260524155736-bd1e602d2f12
...
replace github.com/filecoin-project/curio => github.com/Reiers/curio v1.27.3-0.20260524164629-dbaa2bf44bd1
