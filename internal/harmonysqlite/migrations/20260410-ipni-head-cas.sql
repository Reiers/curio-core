...
-- Source: github.com/filecoin-project/curio harmony/harmonydb/sql/20260410-ipni-head-cas.sql
...
-- Flagged constructs: DO $$ block, CREATE FUNCTION (plpgsql), JSONB (mapped to TEXT), ARRAY types (mapped to TEXT/JSON)
--

DROP FUNCTION IF EXISTS insert_ad_and_update_head(
    TEXT, BLOB, BLOB, TEXT, TEXT, BIGINT, INTEGER, TEXT, TEXT, BLOB, TEXT
);
