...
-- Source: github.com/filecoin-project/curio harmony/harmonydb/sql/20250818-restart-request.sql
...
ALTER TABLE harmony_machines ADD COLUMN IF NOT EXISTS restart_request DATETIME;
