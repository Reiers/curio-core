...
-- Source: github.com/filecoin-project/curio harmony/harmonydb/sql/20260416-mk20-ddo-contracts.sql
...
-- Flagged constructs: CREATE FUNCTION (plpgsql), JSONB (mapped to TEXT), ARRAY types (mapped to TEXT/JSON)
--

CREATE TABLE IF NOT EXISTS ddo_contracts (
    address TEXT PRIMARY KEY,
    allowed INTEGER NOT NULL DEFAULT FALSE
);
